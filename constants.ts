...
export const MEAL_PLAN: MealCategory[] = [
  {
    ...
    options: [
      { id: 'b1', name: '3 eggs (150 g) + wheat bread 2 slices (60 g)', quantity: '150g eggs + 60g bread', kcal: 380, protein: 26, carbs: 28, fat: 18, fiber: 4 },
      { id: 'b2', name: 'Oats 60 g + whey 1 scoop', quantity: '60g oats + 1 scoop whey', kcal: 390, protein: 32, carbs: 35, fat: 12, fiber: 7 },
      { id: 'b3', name: 'Sweet potato boiled 200 g + eggs 2', quantity: '200g sweet potato + 2 eggs', kcal: 430, protein: 22, carbs: 45, fat: 14, fiber: 8 },
      { id: 'b4', name: 'Curd 250 g + almonds 10 pcs', quantity: '250g curd + 10 almonds', kcal: 360, protein: 24, carbs: 14, fat: 14, fiber: 2 },
      { id: 'b5', name: 'Paneer bhurji 100 g + chapati 1', quantity: '100g paneer + 1 chapati', kcal: 450, protein: 28, carbs: 30, fat: 18, fiber: 5 },
      { id: 'b6', name: 'Mixed sprouts (plain) 150 g', quantity: '150g', kcal: 360, protein: 20, carbs: 42, fat: 6, fiber: 8 },
      { id: 'b7', name: 'Boiled chickpeas 150 g', quantity: '150g', kcal: 410, protein: 18, carbs: 55, fat: 8, fiber: 12 },
      { id: 'b8', name: 'Upma 200 g + milk 200 ml', quantity: '200g upma + 200ml milk', kcal: 440, protein: 18, carbs: 52, fat: 14, fiber: 7 },
      { id: 'b9', name: 'Omelette (3 eggs) + toast 1 slice', quantity: '3 eggs + 1 toast', kcal: 390, protein: 27, carbs: 20, fat: 22, fiber: 3 },
      { id: 'b10', name: 'Paneer 120 g + boiled potato 120 g', quantity: '120g paneer + 120g potato', kcal: 430, protein: 26, carbs: 38, fat: 16, fiber: 6 },
    ]
  },
  {
    id: 'midSnack',
    ...
    options: [
      { id: 'ms1', name: 'Orange 130 g', quantity: '130g', kcal: 60, protein: 1, carbs: 15, fat: 0, fiber: 3 },
      { id: 'ms2', name: 'Watermelon 300 g', quantity: '300g', kcal: 90, protein: 2, carbs: 22, fat: 0, fiber: 1 },
      { id: 'ms3', name: 'Cucumber-carrot-beet salad 250 g', quantity: '250g', kcal: 120, protein: 4, carbs: 18, fat: 1, fiber: 6 },
      { id: 'ms4', name: 'Buttermilk 250 ml', quantity: '250ml', kcal: 120, protein: 4, carbs: 10, fat: 3, fiber: 1 },
      { id: 'ms5', name: 'Sweet potato 100 g', quantity: '100g', kcal: 150, protein: 2, carbs: 35, fat: 1, fiber: 4 },
      { id: 'ms6', name: 'Sprouts salad 120 g', quantity: '120g', kcal: 180, protein: 10, carbs: 25, fat: 5, fiber: 7 },
      { id: 'ms7', name: 'Boiled corn 120 g', quantity: '120g', kcal: 230, protein: 6, carbs: 40, fat: 4, fiber: 6 },
      { id: 'ms8', name: 'Coconut water 250 ml', quantity: '250ml', kcal: 60, protein: 1, carbs: 15, fat: 0, fiber: 1 },
      { id: 'ms9', name: 'Orange + peanuts 10 g', quantity: '130g orange + 10g peanuts', kcal: 120, protein: 3, carbs: 15, fat: 6, fiber: 3 },
      { id: 'ms10', name: 'Watermelon + seeds 1 tsp', quantity: '300g watermelon + 1tsp seeds', kcal: 130, protein: 3, carbs: 22, fat: 4, fiber: 3 },
    ]
  },
  {
    id: 'lunch',
    ...
    options: [
      { id: 'l1', name: 'Rice 180 g + dal 30 g raw + veg 150 g', quantity: '180g rice, 30g dal, 150g veg', kcal: 500, protein: 22, carbs: 70, fat: 10, fiber: 9 },
      { id: 'l2', name: 'Chicken curry 150 g + rice 160 g', quantity: '150g chicken, 160g rice', kcal: 520, protein: 35, carbs: 60, fat: 14, fiber: 5 },
      { id: 'l3', name: 'Fish curry 150 g + rice 160 g', quantity: '150g fish, 160g rice', kcal: 510, protein: 32, carbs: 58, fat: 15, fiber: 5 },
      { id: 'l4', name: 'Rajma 150 g + rice 150 g', quantity: '150g rajma, 150g rice', kcal: 520, protein: 22, carbs: 72, fat: 10, fiber: 13 },
      { id: 'l5', name: 'Paneer curry 120 g + chapati 2', quantity: '120g paneer + 2 chapatis', kcal: 520, protein: 30, carbs: 45, fat: 18, fiber: 7 },
      { id: 'l6', name: 'Lemon rice 200 g + curd 100 g', quantity: '200g rice, 100g curd', kcal: 510, protein: 16, carbs: 70, fat: 12, fiber: 6 },
      { id: 'l7', name: 'Boiled chana 180 g + veg 150 g', quantity: '180g chana, 150g veg', kcal: 500, protein: 24, carbs: 55, fat: 10, fiber: 13 },
      { id: 'l8', name: 'Egg curry (3 eggs) + rice 150 g', quantity: '3 eggs, 150g rice', kcal: 520, protein: 28, carbs: 58, fat: 14, fiber: 5 },
      { id: 'l9', name: 'Millet rice 180 g + sambar 200 ml', quantity: '180g millet, 200ml sambar', kcal: 500, protein: 18, carbs: 65, fat: 10, fiber: 12 },
      { id: 'l10', name: 'Goat meat curry 150 g + rice 120 g', quantity: '150g meat, 120g rice', kcal: 550, protein: 34, carbs: 45, fat: 22, fiber: 4 },
    ]
  },
  {
    id: 'eveningSnack',
    ...
    options: [
      { id: 'es1', name: 'Sprouts salad 150 g', quantity: '150g', kcal: 230, protein: 12, carbs: 30, fat: 6, fiber: 8 },
      { id: 'es2', name: 'Boiled chickpeas 120 g', quantity: '120g', kcal: 210, protein: 10, carbs: 35, fat: 4, fiber: 7 },
      { id: 'es3', name: 'Roasted chana 50 g', quantity: '50g', kcal: 210, protein: 10, carbs: 30, fat: 4, fiber: 8 },
      { id: 'es4', name: 'Sweet potato 150 g', quantity: '150g', kcal: 230, protein: 4, carbs: 45, fat: 2, fiber: 6 },
      { id: 'es5', name: 'Whey protein (water)', quantity: '1 scoop', kcal: 200, protein: 30, carbs: 6, fat: 2, fiber: 1 },
      { id: 'es6', name: 'Milk 250 ml', quantity: '250ml', kcal: 150, protein: 8, carbs: 12, fat: 8, fiber: 0 },
      { id: 'es7', name: 'Paneer cubes 80 g', quantity: '80g', kcal: 220, protein: 14, carbs: 6, fat: 14, fiber: 1 },
      { id: 'es8', name: 'Egg whites 4', quantity: '4 whites', kcal: 210, protein: 26, carbs: 4, fat: 2, fiber: 0 },
      { id: 'es9', name: 'Buttermilk + seeds 1 tbsp', quantity: '250ml + 1tbsp seeds', kcal: 200, protein: 6, carbs: 10, fat: 10, fiber: 3 },
      { id: 'es10', name: 'Boiled corn 120 g', quantity: '120g', kcal: 230, protein: 6, carbs: 40, fat: 4, fiber: 6 },
    ]
  },
  {
    id: 'dinner',
    ...
    options: [
      { id: 'd1', name: 'Grilled chicken 180 g + veg 200 g', quantity: '180g chicken, 200g veg', kcal: 450, protein: 40, carbs: 15, fat: 18, fiber: 6 },
      { id: 'd2', name: 'Fish 180 g + veg 200 g', quantity: '180g fish, 200g veg', kcal: 460, protein: 38, carbs: 12, fat: 20, fiber: 5 },
      { id: 'd3', name: 'Paneer 150 g + veg 200 g', quantity: '150g paneer, 200g veg', kcal: 480, protein: 32, carbs: 18, fat: 22, fiber: 6 },
      { id: 'd4', name: 'Egg bhurji (3 eggs) + veg', quantity: '3 eggs + 200g veg', kcal: 470, protein: 28, carbs: 10, fat: 24, fiber: 4 },
      { id: 'd5', name: 'Dal 40 g raw + veg 200 g', quantity: '40g raw dal, 200g veg', kcal: 450, protein: 22, carbs: 35, fat: 12, fiber: 10 },
      { id: 'd6', name: 'Omelette (3 eggs)', quantity: 'Plain 3 eggs', kcal: 430, protein: 26, carbs: 6, fat: 26, fiber: 2 },
      { id: 'd7', name: 'Goat meat curry 150 g + veg', quantity: '150g meat, 200g veg', kcal: 490, protein: 34, carbs: 10, fat: 28, fiber: 4 },
      { id: 'd8', name: 'Chicken soup 250 ml + toast 1', quantity: '250ml soup + 1 toast', kcal: 440, protein: 35, carbs: 25, fat: 10, fiber: 4 },
      { id: 'd9', name: 'Tofu 180 g + veg 200 g', quantity: '180g tofu, 200g veg', kcal: 460, protein: 30, carbs: 20, fat: 20, fiber: 7 },
      { id: 'd10', name: 'Curd bowl 250 g + seeds 1 tbsp', quantity: '250g curd + 1tbsp seeds', kcal: 460, protein: 28, carbs: 20, fat: 18, fiber: 6 },
    ]
  },
];

const WARM_UP: Exercise[] = [
  { id: 'wu0', name: 'Arm circles', equipment: 'Bodyweight', sets: 1, reps: '30 sec', kcalPerUnit: 0.1, unit: 'second', videoUrl: 'https://www.youtube.com/embed/ta5ib-We25E', formTips: ['Small circles first', 'Keep arms at shoulder height', 'Maintain a steady pace'] },
  { id: 'wu1', name: 'Jumping jacks', equipment: 'Bodyweight', sets: 1, reps: '30 sec', kcalPerUnit: 0.25, unit: 'second', videoUrl: 'https://www.youtube.com/embed/iJ9IIDcYehA', formTips: ['Land softly on your toes', 'Breathe rhythmically', 'Full arm extension'] },
  { id: 'wu2', name: 'Bodyweight squats', equipment: 'Bodyweight', sets: 1, reps: '15 reps', kcalPerUnit: 4, unit: 'set', videoUrl: 'https://www.youtube.com/embed/6mkQ81dq-ts', formTips: ['Hips back first', 'Chest stays up', 'Weight in your heels'] },
  { id: 'wu3', name: 'Shoulder rolls', equipment: 'Bodyweight', sets: 1, reps: '30 sec', kcalPerUnit: 0.1, unit: 'second', videoUrl: 'https://www.youtube.com/embed/cpnEW7GLnHw', formTips: ['Full circular range', 'Relax the neck', 'Slow, controlled motion'] },
  { id: 'wu4', name: 'Hip circles', equipment: 'Bodyweight', sets: 1, reps: '30 sec', kcalPerUnit: 0.1, unit: 'second', videoUrl: 'https://www.youtube.com/embed/_6Smk5o8n4', formTips: ['Wide rotations', 'Keep torso stable', 'Squeeze glutes at the top'] },
];

const UPPER_BODY_EXERCISES: Exercise[] = [
  ...WARM_UP,
  { id: 'up1', name: 'Push-ups', equipment: 'Bodyweight', sets: 3, reps: '10–15', kcalPerUnit: 5, unit: 'set', videoUrl: 'https://www.youtube.com/embed/p6K1HGdzMQs', formTips: ['Core tight like a plank', 'Elbows at 45 degrees', 'Full range of motion'] },
  { id: 'up2', name: 'Dumbbell bench press', equipment: '7–10 kg DBs', sets: 3, reps: '10', kcalPerUnit: 4, unit: 'set', videoUrl: 'https://www.youtube.com/embed/X4Ms_lrg5mw', formTips: ['Press up over mid-chest', 'Stable feet on floor', 'Control the descent'] },
  { id: 'up3', name: 'One-arm DB row', equipment: '10–12 kg', sets: 3, reps: '12', kcalPerUnit: 4, unit: 'set', videoUrl: 'https://www.youtube.com/embed/cmUMdzjzkQA', formTips: ['Pull to the hip, not chest', 'Keep back flat', 'Do not rotate torso'] },
  { id: 'up4', name: 'Shoulder press', equipment: '7–10 kg', sets: 3, reps: '10', kcalPerUnit: 4, unit: 'set', videoUrl: 'https://www.youtube.com/embed/vB6gjxAE9uE', formTips: ['Full extension at top', 'Do not arch lower back', 'Core braced'] },
  { id: 'up5', name: 'Bicep curls', equipment: '7–10 kg', sets: 3, reps: '12', kcalPerUnit: 3, unit: 'set', videoUrl: 'https://www.youtube.com/embed/fAx7fQtQEEA', formTips: ['Keep elbows glued to sides', 'No body swinging', 'Slow lower phase'] },
  { id: 'up6', name: 'Tricep overhead extension', equipment: '7–10 kg', sets: 3, reps: '12', kcalPerUnit: 3, unit: 'set', videoUrl: 'https://www.youtube.com/embed/FGydn8QOyLM', formTips: ['Keep elbows pointing forward', 'Deep stretch at bottom', 'Full lock out'] },
];

const LOWER_BODY_EXERCISES: Exercise[] = [
  ...WARM_UP,
  { id: 'lo1', name: 'Squats', equipment: 'Barbell (20kg)', sets: 3, reps: '15', kcalPerUnit: 8, unit: 'set', videoUrl: 'https://www.youtube.com/embed/0GMZJ85-hoK', formTips: ['Brace core before descent', 'Weight on heels', 'Hips below parallel'] },
...
const FULL_BODY_EXERCISES: Exercise[] = [
  ...WARM_UP,
  { id: 'fb1', name: 'Push-ups', equipment: 'Bodyweight', sets: 3, reps: '12', kcalPerUnit: 5, unit: 'set', videoUrl: 'https://www.youtube.com/embed/p6K1HGdzMQs', formTips: ['Maintain straight line', 'Focus on chest squeeze', 'Controlled pace'] },
  ...
  { id: 'fb3', name: 'DB shoulder press', equipment: '7–10 kg', sets: 3, reps: '10', kcalPerUnit: 4, unit: 'set', videoUrl: 'https://www.youtube.com/embed/vB6gjxAE9uE', formTips: ['Avoid locking elbows', 'Brace abdominal wall', 'Full range'] },
